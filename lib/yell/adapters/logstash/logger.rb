...
module Yell
  module Adapters
    ...
    module Logstash
      ...
      class Logger < Yell::Adapters::Base
      ...
      def default_filename
        ...
        ::File.expand_path(::File.directory?(logdir) ? "#{logdir}/logstasher_#{Yell.env}.log" : "logstasher_#{Yell.env}.log")
      end
    ...
    register( :logstash, Yell::Adapters::Logstash::Logger )
  end
end